...
/**
 * Public-site pagination control — same UX as the admin version but
 * rendered against the slate palette used on the marketing pages.
 *
 * Props:
 ...
 *  - itemLabel:    singular noun, e.g. "member"
 *  - scrollRef:    optional React ref to scroll into view on page change
 */
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-4 py-3 border-t border-slate-200 bg-slate-50/40">
      <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">
        ...
        <span className="text-slate-800">{totalItems}</span> {itemLabel}
        {totalItems === 1 ? "" : "s"}
      </p>

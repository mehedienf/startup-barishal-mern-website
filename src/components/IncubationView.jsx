          ...
          {success ? (
            <div className="flex flex-col gap-6 animate-fadeIn">
              ...
              <p className="text-xs text-center text-slate-500 leading-relaxed px-4">
                Administrators will review your startup profile. You can check the database statistics directly in the <strong>MERN Admin DB Panel</strong> in the top navigation bar.
              </p>
